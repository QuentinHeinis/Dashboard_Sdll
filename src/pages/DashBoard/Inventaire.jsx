...
<div className="flexer_container">
  ...
  <form id="csv_form" className='relative mt-3 border-2 border-main-rose' >
      ...
      <input id="csv_files" type="file" accept='.csv' name="csv_files" multiple></input>
      <label className="mag" >Magasin</label>
      <select id="csv_mag" name="csv_mag">
      ...
      <input type="submit" name="csv_submit" value="Uploader (2 click a la premiere utilisation)" className='bg-slate-500 px-4 py-2 rounded-lg text-slate-50'></input>
